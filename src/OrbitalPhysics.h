...
namespace OrbitalPhysicsFunctions {
    ...
    void updateSatellitePositions(std::vector<Sun*>& stars, std::vector<Planet*>& satellites, GLfloat graviationalForce, GLfloat timeStep);
    void updateCelestialBodyAngles(std::vector<Sun*>& stars, std::vector<Planet*>& satellites, GLfloat timeStep);
}
