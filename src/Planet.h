...
{
	public:
		explicit Planet(float mass=1.0f, std::shared_ptr<Material> material=std::make_shared<Material>(), GLfloat radius=0.5f, std::shared_ptr<Mesh> sphereMesh=std::shared_ptr<Mesh>());
